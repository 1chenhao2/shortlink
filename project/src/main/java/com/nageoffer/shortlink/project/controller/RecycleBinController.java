...
public class RecycleBinController {
    ...
    public Result<IPage<ShortLinkPageRespDTO>> pageShortLink(ShortLinkRecycleBinPageReqDTO reqDTO){
        return Results.success(recycleBinService.pageRecycleBinShortLink(reqDTO));
    }
