...
public interface ShortLinkStatsService {
     ...
     * 获取单个短链接访问记录
     *
     * @param reqDTO 获取短链接访问记录入参
     * @return 短链接访问记录
     */
    IPage<ShortLinkStatsAccessRecordRespDTO> getShortLinkStatsAccessRecord(ShortLinkStatsAccessRecordReqDTO reqDTO);
     ...
     * 获取分组短链接访问记录
     *
     * @param requestParam 获取分组短链接访问记录入参
     * @return 分组短链接访问记录
     */
