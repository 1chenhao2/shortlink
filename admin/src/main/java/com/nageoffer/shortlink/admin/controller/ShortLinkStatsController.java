...
public class ShortLinkStatsController {
    ...
    public Result<ShortLinkStatsRespDTO> shortLinkStats(ShortLinkStatsReqDTO requestParam) {
        return shortLinkActualRemoteService.oneShortLinkStats(
                ...
                requestParam.getEnableStatus() == null ? 0 : requestParam.getEnableStatus()
        );
    }
    ...
    public Result<Page<com.nageoffer.shortlink.admin.remote.dto.resp.ShortLinkStatsAccessRecordRespDTO>> shortLinkStatsAccessRecord(ShortLinkStatsAccessRecordReqDTO requestParam) {
